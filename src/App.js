...
function App() {
  ...
  return (
    ...
    {isModalReview && <ModalReview onExitModalReview={onExitModalReview} room={room} />}
    {isModalUpdateProperty && <ModalUpdateProperty onExitModalUpdateProperty={onExitModalUpdateProperty} property={property} updateSuccess={updateSuccess}/>}
    {isModalListRoom && <ModalListRoom onExitModalListRoom={onExitModalListRoom} onActiveModalUpdateRoom={onActiveModalUpdateRoom} property={property}/>}
    {isModalUpdateRoom && <ModalUpdateRoom onExitModalUpdateRoom={onExitModalUpdateRoom} room={room}/>}
    <Layout onBackdrop={onActiveLogin}>
      <Switch>
        ...
        <Route path='/reservation/:reservationId'>
           {authCtx.isLoggedIn && <ReservationDetail />}
        </Route>
        <Route path='/my_account'>
          {authCtx.isLoggedIn && <MyAccount />}
        </Route>
        <Route path='/manage_property'>
          {authCtx.isLoggedIn && <ManageProperty onActiveModalUpdateProperty={onActiveModalUpdateProperty} index={index} onActiveModalListRoom={onActiveModalListRoom}/>}
        </Route>
        <Route path='*'>
          <NotFound />
        </Route>
